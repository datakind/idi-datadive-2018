...
1. Install docker on your system: [Docker Install Docs](https://docs.docker.com/install/)
2. Build the docker container: `docker build -t idi:latest .`
    * Should be uploaded to a docker hub account so you will not need to build on every computer
3. Run the container: `docker run -d -p 5000:5000 idi:latest`
